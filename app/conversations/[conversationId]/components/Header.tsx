...
import ProfileDrawe from './ProfileDrawe';
...
const Header: React.FC<HeaderProps> = ({ conversation }) => {
  ...
  return (
    <>
      <ProfileDrawe data={conversation} isOpen={drawerOpen} onClose={() => setDrawerOpen(false)} />
      <div className="flex w-full items-center justify-between border-b-[1px] bg-white px-4 py-3 shadow-sm sm:px-4 lg:px-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-sm font-light text-neutral-500">{statusTest}</div>
          </div>
        </div>
